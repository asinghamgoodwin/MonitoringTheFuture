...
<details>
  <summary>Click to expand summary data from this table (ugly formatting, I hope to find an R tool that makes this easier to parse, like "proc freq" in SAS!)</summary>
