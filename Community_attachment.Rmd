...
First, define the list of variables we want. The original paper includes demographics (covariates), measures of community attachment, and substance use.
...
*NOTE: Check in on the values here... there's a lot more missing data (`-9`) than I expected! Also, it would probably be helpful to recode `-9` as `NA` so I could take advantage of R's built-in understandings of missing data.*
